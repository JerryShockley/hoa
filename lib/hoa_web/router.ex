defmodule HoaWeb.Router do
  use HoaWeb, :router

  import HoaWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {HoaWeb.Layouts, :root}
  ...
  if Application.compile_env(:hoa, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: HoaWeb.Telemetry
  ...
  scope "/", HoaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{HoaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", HoaWeb do
    ...
    live_session :current_user,
      on_mount: [{HoaWeb.UserAuth, :mount_current_user}] do
