defmodule Hoa.DirectoryTest do
  ...
  describe "homes" do
    ...
    test "list_homes/0 returns all homes" do
      {:ok, home} =  Fixture.home_fixture()
      home_list = Directory.list_homes()
      [home1 | _] = home_list
      assert home1 == home
    end
    ...
    test "get_home!/2 returns the home (inclusive nested) with given id" do
      {:ok, home} = Fixture.home_fixture_with_nested()
      home1 = Directory.get_home!(home.id, true)
      assert  home == home1
    end
  ...
  describe "people" do
    ...
    test "list_people/0 returns all people" do
      {:ok, person} = Fixture.person_fixture()
      [person1 | _] = Directory.list_people()
